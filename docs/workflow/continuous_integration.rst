...
First decide if you will add your agent to the already exiting agent pool, or if you wish to add a new pool, by clicking on Add pool.
If you choose to add a new pool, make sure to click on securtiy and add permissions to your team/self (you cannot directly add your own account), as well as  granting access permission to all pipelines.
...
Here, you will select your organization name (https://dev.azure.com/{your_organization}), input your generated PAT, agent pool name, and agent name. 
